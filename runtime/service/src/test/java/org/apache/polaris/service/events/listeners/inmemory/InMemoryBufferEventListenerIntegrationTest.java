...
class InMemoryBufferEventListenerIntegrationTest {
  ...
  void testReportMetricsEventWithTraceContext() throws IOException {
    ...
    // Query for the AfterReportMetricsEvent
    String query =
        "SELECT * FROM polaris_schema.events WHERE realm_id = '"
            + realm
            + "' AND event_type = 'AfterReportMetricsEvent' ORDER BY timestamp_ms DESC";
    ...
    assertThat(metricsEvent.getEventType()).isEqualTo("AfterReportMetricsEvent");
  ...
  void testReportMetricsWithTraceIdInMetadata() throws IOException {
    ...
    String query =
        "SELECT * FROM polaris_schema.events WHERE realm_id = '"
            + realm
            + "' AND event_type = 'AfterReportMetricsEvent' AND request_id = 'trace-test-456'";
  ...
  void testReportCommitMetrics() throws IOException {
    ...
    String query =
        "SELECT * FROM polaris_schema.events WHERE realm_id = '"
            + realm
            + "' AND event_type = 'AfterReportMetricsEvent' AND request_id = 'commit-test-789'";
